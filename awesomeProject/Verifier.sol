...
contract PlonkVerifier {
  ...
  uint256 private constant G2_SRS_1_X_0 = 1563241040496190483107337216526050011984935900612792368750945934971573223712;
  uint256 private constant G2_SRS_1_X_1 = 21590515054738754443110181798937515466299526659304469905446411684089171643778;
  uint256 private constant G2_SRS_1_Y_0 = 4074561388161848203461235516326258916211190771358555890194576325510467003330;
  uint256 private constant G2_SRS_1_Y_1 = 16610715623264148283448785069328457150046256498442966435295875206877028270853;
  
  uint256 private constant G1_SRS_X = 1;
  uint256 private constant G1_SRS_Y = 2;

  // ----------------------- vk ---------------------
  uint256 private constant VK_NB_PUBLIC_INPUTS = 516;
  uint256 private constant VK_DOMAIN_SIZE = 4194304;
  uint256 private constant VK_INV_DOMAIN_SIZE = 21888237653275510688422624196183639687472264873923820041627027729598873448513;
  uint256 private constant VK_OMEGA = 12143866164239048021030917283424216263377309185099704096317235600302831912062;
  uint256 private constant VK_QL_COM_X = 15071016534752066845219955257951440003307358432595913993209425400222771402431;
  uint256 private constant VK_QL_COM_Y = 12205721595787722488042297677074268632511071662800184950578766875696662763237;
  uint256 private constant VK_QR_COM_X = 12585195690059437054915357192544112018236264155990869814554382546945569100951;
  uint256 private constant VK_QR_COM_Y = 17168645929971438316129387025757350531437748601448670453915802041570704215901;
  uint256 private constant VK_QM_COM_X = 16795164638073820736066439404388581080060516020428744068837392646775234230082;
  uint256 private constant VK_QM_COM_Y = 15422533432523631618556991204463339911259585847361986444358586880124515934524;
  uint256 private constant VK_QO_COM_X = 6061750417414764432200490285231906249961184919488200448491464737363839135066;
  uint256 private constant VK_QO_COM_Y = 15565820292676527383552182369965771815862286455459463611394369950078428546307;
  uint256 private constant VK_QK_COM_X = 7293180814493977075533234360077974514583819079270296060639697585653336383562;
  uint256 private constant VK_QK_COM_Y = 848151480657591170213094466908057092792126314316177248153934971097364386012;
  
  uint256 private constant VK_S1_COM_X = 14726565799153059370877807859660179581669553450182270442365634084360009317363;
  uint256 private constant VK_S1_COM_Y = 13251045883911503136318735774924253396335090980199585795761229760580413075088;
  
  uint256 private constant VK_S2_COM_X = 12814925732838442329074387750177441101402544745924183894415523774326803263113;
  uint256 private constant VK_S2_COM_Y = 7408044579138458494290977221958186228507693035668633185985332622269104783124;
  
  uint256 private constant VK_S3_COM_X = 17279983234935871058604055190618643147123398405427679314670897151268638253395;
  uint256 private constant VK_S3_COM_Y = 18060489317559001663793932429435354971466844799468212521221311509411480647884;
